...
void man(char *name)
{
	...
	{
		printf("Description : Used to closed opended file\n");
	...
	{
		printf("Description : Used to delete ths file\n");
	...
	while(1)
	{
		...
		else if(count == 2)
		{
			...
			else if(strcmp(command[0],"write") == 0)
			{
                ...
                if(ret == 0)
				{
                printf("Error : Incorect Prameter\n");
                continue;
				}		
			    ...
			    if(ret == -2)
                 printf("ERROR: There is no memory sufficient to write\n");
			    if(ret == -3)
		...
		else if(count == 3)
		{
			...
			else if(strcmp(command[0],"open")==0)
			{
				...
				if(ret >= 0)
					printf("File is succesfully opned with file descriptor:%d\n",ret);
				if(ret >= -1)
					printf("ERROR: Incorrect parameter\n");
				if(ret >= -2)
